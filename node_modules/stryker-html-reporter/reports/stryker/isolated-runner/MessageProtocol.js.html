<html>
<head>
    <title>MessageProtocol.js - Stryker report</title>
...
<body>  
    ...
    <div class="container-fluid">
        <h1>MessageProtocol.js - Stryker report</h1><div class="col-md-12">
    <h2>Summary</h2>
    <div class="row">
        <div class="col-xs-11">
            <table class="table table-hover table-bordered table-no-top">
                <thead>
                    ...
                    <tr>
                        <td><a href="MessageProtocol.js.html">MessageProtocol.js</a></td>
                        <td>
                            <div class="progress">
...
//# sourceMappingURL&#x3D;MessageProtocol.js.ma</span>p</code></pre>
</div><footer>
