<html>
<head>
    <title>coverage - Stryker report</title>
...
<body>  
    ...
    <div class="container-fluid">
        <h1>coverage - Stryker report</h1><div class="col-md-12">
    <div class="row">
        <div class="totals col-xs-11">
            ...
            <table class="table table-hover table-bordered table-no-top">
                <thead>
                    ...
                    <tr>
                        <td><a href="coverage/index.html">coverage</a></td>
                        <td>
                            <div class="progress">
                        ...
                        <th class="text-center" style="width: 10%">36/48</th>
