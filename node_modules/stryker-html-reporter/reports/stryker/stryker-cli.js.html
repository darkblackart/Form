<html>
<head>
    <title>stryker-cli.js - Stryker report</title>
...
<body>  
    ...
    <div class="container-fluid">
        <h1>stryker-cli.js - Stryker report</h1><div class="col-md-12">
    <h2>Summary</h2>
    <div class="row">
        <div class="col-xs-11">
            <table class="table table-hover table-bordered table-no-top">
                <thead>
                    ...
                    <tr>
                        <td><a href="stryker-cli.js.html">stryker-cli.js</a></td>
                        <td>
                            <div class="progress">
                        ...
                        <th class="text-center" style="width: 10%">0/9</th>
...
function list(val) </span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="0"><span class="label label-danger">0</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="0">{
...
program
    ...
    .option(&#x27;-c, --configFile &lt;configFileLocation&gt;&#x27;, </span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="1"><span class="label label-danger">1</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="1">&#x27;A location to a config file. That file should export a function which accepts a &quot;config&quot; object\n&#x27; - ConfigReader_1.CONFIG_SYNTAX_HELP</span><span class="stryker-original-code" data-mutant="1"><span class="bg-danger">&#x27;A location to a config file. That file should export a function which accepts a &quot;config&quot; object\n&#x27; +
    ConfigReader_1.CONFIG_SYNTAX_HELP</span></span><span class="bg-null">)
    ...
    .parse(process.argv);
log4js.setGlobalLogLevel(</span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="2"><span class="label label-danger">2</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="2">program[&#x27;logLevel&#x27;] &amp;&amp; &#x27;info&#x27;</span><span class="stryker-original-code" data-mutant="2"><span class="bg-danger">program[&#x27;logLevel&#x27;] || &#x27;info&#x27;</span></span><span class="bg-null">);
// Cleanup commander state
delete program.options;
delete program.rawArgs;
delete program.args;
delete program.commands;
for (var i in program) </span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="3"><span class="label label-danger">3</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="3">{
}</span><span class="stryker-original-code" data-mutant="3"><span class="bg-danger">{
    if (</span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="4"><span class="label label-danger">4</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="4">false</span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="5"><span class="label label-danger">5</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="5">true</span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="6"><span class="label label-danger">6</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="6">i.charAt(0) !&#x3D;&#x3D; &#x27;_&#x27;</span><span class="stryker-original-code" data-mutant="4"><span class="stryker-original-code" data-mutant="5"><span class="stryker-original-code" data-mutant="6"><span class="bg-danger">i.charAt(0) &#x3D;&#x3D;&#x3D; &#x27;_&#x27;</span></span></span></span><span class="bg-danger">) </span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="7"><span class="label label-danger">7</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="7">{
}</span><span class="stryker-original-code" data-mutant="7"><span class="bg-danger">{
        delete program[i];
    }</span></span><span class="bg-danger">
}</span></span><span class="bg-null">
new Stryker_1.default(program).runMutationTest()
    .catch(function (err) </span><a href="#" class="stryker-mutant-button" data-mutant-status-annotation="danger" data-mutant="8"><span class="label label-danger">8</span></a><span class="label label-info stryker-mutant-replacement" hidden data-mutant="8">{
}</span><span class="stryker-original-code" data-mutant="8"><span class="bg-danger">{ return log.error(&quot;an error occurred&quot;, err); }</span></span><span class="bg-null">);
//# sourceMappingURL&#x3D;stryker-cli.js.ma</span>p</code></pre>
</div><footer>
