<html>
<head>
    <title>FileStatements.js - Stryker report</title>
...
<body>  
    ...
    <div class="container-fluid">
        <h1>FileStatements.js - Stryker report</h1><div class="col-md-12">
    <h2>Summary</h2>
    <div class="row">
        <div class="col-xs-11">
            <table class="table table-hover table-bordered table-no-top">
                <thead>
                    ...
                    <tr>
                        <td><a href="FileStatements.js.html">FileStatements.js</a></td>
                        <td>
                            <div class="progress">
...
//# sourceMappingURL&#x3D;FileStatements.js.ma</span>p</code></pre>
</div><footer>
